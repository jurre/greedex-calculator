...
export default async function AuthFlowLayout({
  ...
  return (
    <div className="relative min-h-svh overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex min-h-svh max-w-7xl flex-col justify-center gap-6 p-4 sm:px-6 sm:py-10 md:px-8">
        {/* Back to Home button outside of cards */}
